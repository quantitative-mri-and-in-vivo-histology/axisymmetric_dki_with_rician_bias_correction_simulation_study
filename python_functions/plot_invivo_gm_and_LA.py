...
data = loadmat(r"data_invivo_gm_and_LA.mat")

snrs = data["data_invivo_gm_and_LA"]
data_barplots = np.array(data["data_invivo_gm_and_LA"])
...
fig.savefig('invivo_gm_and_LA.png', dpi=1200, pad_inches = 0, bbox_inches = 'tight')
fig.savefig('invivo_gm_and_LA.svg', dpi=1200, bbox_inches = 'tight', pad_inches = 0)