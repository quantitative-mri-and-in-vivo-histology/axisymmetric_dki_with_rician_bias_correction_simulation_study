...
data = loadmat(r"data_invivo_wm_and_synth_iqr.mat")

snrs = data["data_invivo_wm_and_synth_iqr"]

data_barplots = np.array(data["data_invivo_wm_and_synth_iqr"])
...
fig.savefig('data_invivo_wm_and_synth_iqr.png', dpi=1200, pad_inches = 0, bbox_inches = 'tight')
fig.savefig('data_invivo_wm_and_synth_iqr.svg', dpi=1200, bbox_inches = 'tight', pad_inches = 0)